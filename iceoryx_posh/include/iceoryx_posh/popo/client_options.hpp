...
struct ClientOptions
{
    ...
    ResponseQueueFullPolicy responseQueueFullPolicy{ResponseQueueFullPolicy::DISCARD_OLDEST_DATA};

    /// @brief The option whether the client should block when the request queue is full
    ServerTooSlowPolicy serverTooSlowPolicy{ServerTooSlowPolicy::DISCARD_OLDEST_DATA};
