...
struct ServerOptions
{
    ...
    ClientTooSlowPolicy clientTooSlowPolicy{ClientTooSlowPolicy::DISCARD_OLDEST_DATA};
    ...
    static ServerOptions deserialize(const cxx::Serialization& serialized) noexcept;
};
