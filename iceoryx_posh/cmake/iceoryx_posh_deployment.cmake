...
if(NOT IOX_MAX_CLIENTS)
    set(IOX_MAX_CLIENTS 1024)
endif()
message(STATUS "[i] IOX_MAX_CLIENTS:" ${IOX_MAX_CLIENTS})

if(NOT IOX_MAX_SERVERS)
    set(IOX_MAX_SERVERS 512)
endif()
message(STATUS "[i] IOX_MAX_SERVERS:" ${IOX_MAX_SERVERS})
