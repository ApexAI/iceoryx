...
iox::config::TomlGatewayConfigParser::parse(const roudi::ConfigFilePathString_t& path) noexcept
{
    ...
    iox::cxx::FileReader configFile(
        cxx::convert<roudi::ConfigFilePathString_t, std::string>(path), "", cxx::FileReader::ErrorMode::Ignore);
    ...
    for (const auto& service : *serviceArray)
    {
        ...
        entry.m_serviceDescription =
            iox::capro::ServiceDescription(cxx::convert<std::string, iox::capro::IdString_t>(*serviceName),
                                           cxx::convert<std::string, iox::capro::IdString_t>(*instance),
                                           cxx::convert<std::string, iox::capro::IdString_t>(*event));
