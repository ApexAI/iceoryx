...
The error handler is a central instance for collecting all errors and react to them. The `error-handling.hpp` contains a list of all error enum values. The error handler has different error levels, for more information see [error handling article](http://iceoryx.io/latest/design/error-handling/)
...
For information about how to use the logger API see [error handling article](http://iceoryx.io/latest/design/error-handling/)
