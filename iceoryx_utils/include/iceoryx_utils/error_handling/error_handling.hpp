...
#define ICEORYX_ERRORS(error) \
    ...
    error(POSH__RUNTIME_APP_WITH_SAME_NAME_STILL_RUNNING) \
    ...
    error(POPO__CONDITION_VARIABLE_WAITER_SEMAPHORE_CORRUPTED_IN_WAS_TRIGGERED) \
    error(POPO__CONDITION_VARIABLE_WAITER_SEMAPHORE_CORRUPTED_IN_WAIT) \
    error(POPO__CONDITION_VARIABLE_WAITER_SEMAPHORE_CORRUPTED_IN_TIMED_WAIT) \
    ...
    error(POPO__EVENT_VARIABLE_WAITER_SEMAPHORE_CORRUPTED_IN_DESTROY) \
    error(POPO__EVENT_VARIABLE_WAITER_SEMAPHORE_CORRUPTED_IN_WAIT) \
    error(POPO__EVENT_VARIABLE_WAITER_SEMAPHORE_CORRUPTED_IN_RESET) \
    error(POPO__EVENT_NOTIFIER_INDEX_TOO_LARGE) \
    ...
    error(IPC_INTERFACE__APP_ALREADY_REGISTERED) \
