...
class MinimalSkeleton
{
  public:
    ...
    void OfferService()
    {
        // Should call PoshRuntime::OfferService, how to add the Service Registry entry instead?
        m_event.Offer();
    }

    void StopOfferService()
    {
        // Should call PoshRuntime::StopOfferService, how to remove the Service Registry entry instead?
        m_event.StopOffer();
    }
