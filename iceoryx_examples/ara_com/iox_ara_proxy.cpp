...
constexpr char APP_NAME[] = "iox-cpp-ara-proxy";
...
int main()
{
    ...
    com::InstanceIdentifier exampleInstanceSearchQuery(TruncateToCapacity, "Example");
    ...
    else
    {
        ...
        auto callback = [&](com::ServiceHandleContainer<ara::com::ProxyHandleType> container,
    ...
    {
        {
            ...
            if (proxyGuard->has_value())
            {
                ...
                {
                    std::cout << "Empty future received, please start the 'iox-cpp-ara-skeleton'." << std::endl;
                }
