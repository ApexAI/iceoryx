...
#ifndef IOX_EXAMPLES_ARA_COM_FIELD_PUBLISHER_HPP
#define IOX_EXAMPLES_ARA_COM_FIELD_PUBLISHER_HPP
...
class FieldPublisher
{
  public:
    ...
    void Update(const FieldType& userField)
    {
    ...
    void RegisterGetHandler(std::function<void()> getHandler)
    {
    }

    void RegisterSetHandler(std::function<void()> setHandler)
    {
    }
...
#endif // IOX_EXAMPLES_ARA_COM_FIELD_PUBLISHER_HPP
