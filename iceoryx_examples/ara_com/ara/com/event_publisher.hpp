...
class EventPublisher
{
  public:
    ...
    EventPublisher(const core::String& service, const core::String& instance, const core::String& event)
        : m_publisher({service, instance, event}, {0U, "", false})
    {
    }

    void Send(const SampleType& userSample)
    {
    ...
    void Send(ara::com::SampleAllocateePtr<SampleType> userSamplePtr)
    {
