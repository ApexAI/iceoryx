...
#ifndef IOX_EXAMPLES_ARA_COM_EVENT_SUBSCRIBER_UDS_HPP
#define IOX_EXAMPLES_ARA_COM_EVENT_SUBSCRIBER_UDS_HPP
...
class EventSubscriberUds
{
  public:
                                            ...
                                            size_t maxNumberOfSamples = std::numeric_limits<size_t>::max()) noexcept
    {
        ...
        ara::core::Result<size_t> numberOfSamples{1};
...
#endif // IOX_EXAMPLES_ARA_COM_EVENT_SUBSCRIBER_UDS_HPP
