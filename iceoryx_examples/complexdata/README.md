...
reimplemented some [constructs](https://github.com/eclipse-iceoryx/iceoryx/blob/master/iceoryx_hoofs/README.md#cxx). This example shows how
...
[icedelivery example](https://github.com/eclipse-iceoryx/iceoryx/blob/master/iceoryx_examples/icedelivery/README.md) to send the
...
[here](https://github.com/eclipse-iceoryx/iceoryx/blob/master/iceoryx_hoofs/README.md#cxx).
...
!!! note
    ...
    [How optional and error values are returned in iceoryx](https://iceoryx.io/latest/concepts/how-optional-and-error-values-are-returned-in-iceoryx/#optional).
